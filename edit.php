...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `users` SET `first_name`='$first_name',`middle_name`='$middle_name',`last_name`='$last_name',`family_name`='$family_name',`email`='$email, `password`='$password, `confirm_password `='$confirm_password  WHERE id = $id";
